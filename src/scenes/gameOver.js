...
export function gameOver(citySfx) {

    citySfx.paused = true;
    const gameOverSfx = k.play("gameOver", { volume: 0.5, loop: false });

    let bestScore = k.getData("best-score");
    const currentScore = k.getData("current-score");

    const rankGrades = ["F", "E", "D", "C", "B", "A", "S", "S+"];
    const rankValues = [50, 80, 100, 200, 300, 400, 500, 1000];
